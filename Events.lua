...
local update_url = "https://raw.githubusercontent.com/Vrednaya1234/Admin-Events/main/update.ini" -- тут тоже свою ссылку
...
sampAddChatMessage(tag .. "Успешно загружен!")
	sampAddChatMessage(tag .. "Автор скрипта: "..script_author.." Версия: " ..script_vers_text)
